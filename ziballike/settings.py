"""
Django settings for ziballike project.
...
SECRET_KEY = 'django-insecure-^hv#^-+254%5vjv96qj56uea7x31^%!zcxmwl^-6p*j1=l11)p'
...
WSGI_APPLICATION = 'ziballike.wsgi.application'
